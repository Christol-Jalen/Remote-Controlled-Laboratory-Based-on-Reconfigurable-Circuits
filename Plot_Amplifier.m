%t_row = 1:1:130432;
t_row = linspace(0, 0.00246,130432);
t = t_row';

Inv_P_In = csvread("Inv_Prototype_In.csv",0,1);
Inv_P_Out = csvread("Inv_Prototype_Out.csv",0,1);
...
Int_P_Out = csvread("Integrator_Prototype_Out.csv",0,1);
Int_N_In = csvread("Integrator_Nonswitched_In.csv",0,1);
Int_N_Out = csvread("Integrator_Nonswitched_Out.csv",0,1);
...
plot (t, Int_P_Out, "red","Linewidth", 1) 
grid on
legend("Vin", "Non-Switched", "Prototype")
